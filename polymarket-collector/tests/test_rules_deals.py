...
class RuleDealTests(unittest.TestCase):
    ...
    def test_excel_and_dashboard_include_rules_and_deals(self):
        ...
        self.assertIn("<h2>Time Trends</h2>", html)
        self.assertIn("<h2>Charts</h2>", html)
        self.assertIn("<h2>Data Quality</h2>", html)
        ...
        self.assertIn("<h2>Time Trends</h2>", dashboard_content.text)
        self.assertIn("<h2>Charts</h2>", dashboard_content.text)
        self.assertIn("<h2>Data Quality</h2>", dashboard_content.text)
        ...
        self.assertIn("Range: All time", filtered_content.text)
