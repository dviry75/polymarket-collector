...
class RuleDealTests(unittest.TestCase):
    ...
    def test_excel_and_dashboard_include_rules_and_deals(self):
        ...
        self.assertIn("<h2>ביצועי חוקים</h2>", html)
        self.assertIn("<h2>תמונת סיכון</h2>", html)
        self.assertIn("<h2>תנאי שוק</h2>", html)
        self.assertIn("<h2>מגמות לאורך זמן</h2>", html)
        self.assertIn("<h2>גרפים</h2>", html)
        ...
        self.assertIn("סיבות יציאה", html)
        ...
        self.assertIn("<h2>ביצועי חוקים</h2>", dashboard_content.text)
